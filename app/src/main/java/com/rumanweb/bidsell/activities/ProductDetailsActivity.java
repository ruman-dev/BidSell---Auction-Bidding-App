...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    EditText edMaxBid;
    Button btnPlaceBid;
    TextView product_title, tvCurrentBid, tvHightlights, tvDesc, tvCountTimer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHightlights = findViewById(R.id.tvHighlights);
        ...
        if (productItemModel != null) {
            ...
            tvHightlights.setText(productItemModel.getHighlights());
